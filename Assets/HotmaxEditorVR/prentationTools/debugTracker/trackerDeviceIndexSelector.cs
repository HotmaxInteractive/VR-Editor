...
public class trackerDeviceIndexSelector : MonoBehaviour
{
    ...
    public GameObject debugTrackerObject;

    private GameObject debugTrackerObjectRef;
    private Text debugTrackerObjectRefText;
    ...
    private void Start()
    {
        debugTrackerObjectRef = Instantiate(debugTrackerObject);
        debugTrackerObjectRefText = debugTrackerObjectRef.GetComponent<Text>();
    ...
    {
        debugTrackerObjectRefText.text = text;
        Invoke("clearDebugText", 1);
    }

    void clearDebugText()
    {
        debugTrackerObjectRefText.text = "";
    }
}
